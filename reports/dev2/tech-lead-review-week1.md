...
> _"Supabase IPv4: Free tier direct connections are IPv6-only. Any dev on an IPv4 network must use Session Pooler. This should be documented in `.env.local.example` for onboarding."_
