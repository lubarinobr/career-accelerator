...
## Shared Information (Both Roles)

### Tech Stack
Next.js 15 | TypeScript | Tailwind CSS | Prisma | Supabase (PostgreSQL) | Auth.js v5 | Claude API (Anthropic) | Vercel

### Team Structure
- **CEO / P.O.** — Defines features and priorities
- **Tech Lead** — Architecture decisions, PR reviews, technical direction
- **Dev 1 (you)** — Infrastructure, auth, deploy
- **Dev 2 (you)** — Database, data model, API logic
- **Senior React Frontend (joining Sprint 2)** — Quiz UI, components, interactions
...
- **Kanban board:** Markdown-based, tracked in the repo (`kanban-sprint1.md`)
- **Branching:** `sprint1/SP1-XX-short-description` per ticket
